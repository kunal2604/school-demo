...
const Profile = () => {
  ...
  const isFollowing = userProfile?.followers.indexOf(user?._id) > -1;
            ...
            <div className='grid grid-cols-2'>
              <section className='flex items-center justify-center'>
                <Avatar className='h-32 w-32'>
                  ...
                  <AvatarFallback>{getInitialsFromUserName(userProfile)}</AvatarFallback>
                </Avatar>
              </section>
              <section>
                <div className='flex flex-col gap-5'>
                  ...
                  <div className='flex flex-col gap-1'>
                    ...
                    <span>🤯Cake murder on 2604</span>
                    <span>🤯Chai peene chale?</span>
                  </div>
                </div>
              </section>
            </div>
