...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        formData.append("gender", input.gender != undefined ? input.gender : user?.gender);
        ...
        try {
            ...
            const editProfileUrl = 'api/v1/user/profile/edit';
            const res = await axios.post(baseUrl + editProfileUrl, formData, {
                headers: {
        ...
        <div>
            {
                userProfile ?
                    <div className='flex max-w-2xl mx-auto pl-10'>
                        <section className='flex flex-col gap-6 w-full my-8'>
                            ...
                            <div>
                                ...
                                <Select defaultValue={userProfile?.gender} onValueChange={selectChangeHandler}>
                    ...
                    <div className='flex max-w-5xl justify-center mx-auto pl-10'>
                        <div className='flex flex-col gap-20 p-8'> Something went wrong </div>
                    </div>
            }
        </div>
    )
